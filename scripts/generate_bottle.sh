...
echo "class EosioCdt < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/eosio/eosforce.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/eosio/eosforce.cdt/releases/download/v${VERSION}\"
