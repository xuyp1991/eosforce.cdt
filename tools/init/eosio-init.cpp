...
struct project {
   ...
   const std::string cmake_extern = "include(ExternalProject)\n"
                                    ...
                                    "   CMAKE_ARGS -DCMAKE_TOOLCHAIN_FILE=${EOSIO_CDT_ROOT}/lib/cmake/eosforce.cdt/EosioWasmToolchain.cmake\n"
                                    "   UPDATE_COMMAND \"\"\n"
                                    "   PATCH_COMMAND \"\"\n"
                                    "   TEST_COMMAND \"\"\n"
                                    "   INSTALL_COMMAND \"\"\n"
   ...
   const std::string readme_bare = " --- @ Project ---\n\n"
                                   " - How to Build -\n"
                                   "   - run the command 'eosforce-cpp -abigen -o @.wasm @.cpp'\n";
...
int main(int argc, const char **argv) {
   ...
   cl::SetVersionPrinter([](llvm::raw_ostream& os) {
        os << "eosforce-init version " << "@VERSION_FULL@" << "\n";
  });
   cl::OptionCategory cat("eosforce-init", "generates an eosio smart contract project");
   ...
   cl::ParseCommandLineOptions(argc, argv, std::string("eosforce-proj"));
   try {
